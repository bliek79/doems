"""Production adapter from native DOEMS transport rows to EMS policy v2.

The DOEMS source of truth remains 288 native 15-minute slots. The compatibility
transport stays rolling 72 x 60 minutes, but production decisions use the
post-G5 physical self_consumption policy. The frozen Alpha76 adapter remains
untouched for historical G5 parity evidence.
"""
...
from .ems_policy_v2 import POLICY_VERSION
from .ems_policy_v2.energy_need import build_energy_need_analysis
from .ems_policy_v2.planner_preview import build_planner_preview
from .ems_policy_v2.planner_72h import build_72h_plan_preview
from .ems_settings import EMSSettings

SOURCE_TAG = POLICY_VERSION
...
def run_ems_chain(*, input_result: dict[str, Any], settings: EMSSettings, soc_percent: float | None, now: datetime | None = None) -> dict[str, Any]:
    ...
    return {
        ...
        "adapter_contract": "alpha41_288_to_72_self_consumption_v2",
