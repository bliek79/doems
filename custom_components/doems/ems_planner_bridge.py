...
def _forced_row_action(
    ...
    *,
    ...
    # self_consumption behaviour of the battery. Production policy v2 support
    # charging is an explicit temporary charge action because it deliberately
    # shifts otherwise unavoidable future grid import to a cheaper hour.
    return None
