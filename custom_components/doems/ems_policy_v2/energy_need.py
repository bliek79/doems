...
def build_energy_need_analysis(
    ...
    # Production policy v2: forecast demand until usable solar is planning
    # context, not an enforceable SOC floor while the physical battery remains
    # in self_consumption.
    ...
    if available_battery_kwh is not None:
        ...
        # Stored battery energy that could economically shift unavoidable
        # future grid import to an earlier cheaper charge window.
