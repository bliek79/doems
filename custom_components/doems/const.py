...
# Frozen Alpha76 EMS logic constants. These are not user-configurable in G6.
EMS_AUTO_EXECUTION_BUFFER_PERCENT = 2.0
EMS_MIN_ACTIONABLE_SAFETY_CHARGE_KWH = 0.10
EMS_PLAN_SLOT_COUNT = 3
