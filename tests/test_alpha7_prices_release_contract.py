...
def test_alpha7_7_versions_prices_files_and_registered_entities():
    ...
    assert 'VERSION = "0.1.0-alpha.7.7"' in const
    assert '"version": "0.1.0-alpha.7.7"' in manifest
    ...
    # and is suppressed by the actual Alpha7.7 runtime manager.
...
def test_alpha7_7_brand_hotfix_preserves_prices_contract():
