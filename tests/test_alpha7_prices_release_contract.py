...
def test_alpha7_6_versions_prices_files_and_registered_entities():
    ...
    assert 'VERSION = "0.1.0-alpha.7.6"' in const
    assert '"version": "0.1.0-alpha.7.6"' in manifest
    ...
    # and is suppressed by the actual Alpha7.6 runtime manager.
...
def test_alpha7_6_brand_hotfix_preserves_prices_contract():
